                ...
                <div className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
                    <div className='mx-auto flex flex-col items-center justify-between h-full px-10 md:flex-row'>
                        <div className='md:h-full md:w-1/2 flex items-center justify-center'>
                            <img src={eventpageImage6} alt='aboutPage' className='rounded-2xl grayscale w-full md:w-[90%] hover:cursor-pointer hover:grayscale-0 hover:scale-105 duration-200' />
                        </div>
                                ...
                                {events.map(({ id, title }) => {
                                    return (
                                        <div key={id} className='py-4 w-1/4 flex justify-start items-center p-2 rounded-2xl'>
                                            <Link to={`/${title}`}>
                                                <p className='cursor-pointer text-3xl text-gray-400 font-medium hover:scale-105 duration-200 hover:text-white'>{title}</p>
                                            </Link>
                                        </div>
                                    )
                                })}
